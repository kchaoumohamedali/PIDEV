 ...
 */
final class Version20220305190207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, prix INT NOT NULL, id_user INT NOT NULL, totale INT NOT NULL, numero INT NOT NULL, date DATE NOT NULL, UNIQUE INDEX UNIQ_6EEAA67DF347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
